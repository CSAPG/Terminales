# -*- coding: utf-8 -*-
# ====================================================================
# Chapitre 3 Exercice 38                                      STANDARD 
# ====================================================================
...
# ====================================================================
# Affichage des valeurs numériques : Date , n(I2) titré , [I-]
# ====================================================================
print('\nDate t \t\t n(I2) titré \t\t [I-]')
...
plt.figure(figsize=(16,4)) # Initialisation de la figure
...
date=[...A compléter... for i in range(N)]  # conversion des dates ti en s 
date.insert(...A compléter...) # insère 0 au début de la liste 'date'

# Liste des valeurs de ln([I-](t)/[I-](t=0)) de t=0s à tmax
Y=[np.log(...A compléter...) for i in range(N)] # Calcul du ln aux dates ti
Y.insert(...A compléter...) # insère 0 au début de la liste 'Y'

# Tracé de ln([I-](t)/[I-](t=0)) = f(t) de t=0s à tmax
plt.plot(...A compléter...,'b+',label='Points expérimentaux')

# Modélisation de la forme y=a*x+b à l'aide de la fonction np.polyfit()
a,b=...A compléter... 
modele=[...A compléter... for i in range(N+1)] # Calcul des ordonnées
                                               # du modéle
# Tracé de la modélisation : modele = f(date)
plt.plot(...A compléter...,'c:',label='Modélisation linéaire')
...
# Liste des vitesses de consommation en ion iodure en mol/L/s de t=0s à tmax
c_I.insert(...A compléter...) # insère [I-](t=0)=c_1/2 en début de liste c_I
v_I=[...A compléter... for i in range(N)]
...
# Modélisation de la forme y=a*x+b à l'aide de la fonction np.polyfit()
m,p=...A compléter...
mod=[...A compléter... for i in range(N)] # Calcul des ordonnées
                                          # du modéle
# Tracé de la modélisation mod = f(c_I)
plt.plot(...A compléter...,'c:',label='Modélisation linéaire')
